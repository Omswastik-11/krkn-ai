...
from krkn_ai.models.config import ConfigFile, FitnessFunction, FitnessFunctionType, HealthCheckConfig
...
class TestKrknRunnerInitialization:
    ...
    def test_init_detects_cli_runner(self, mock_run_shell, minimal_config, temp_output_dir):
    ...
    @patch('krkn_ai.chaos_engines.krkn_runner.run_shell')
    def test_init_raises_when_no_runner_available(self, mock_run_shell, minimal_config, temp_output_dir):
...
class TestKrknRunnerRun:
    ...
    @patch('krkn_ai.chaos_engines.krkn_runner.run_shell')
    def test_run_scenario_with_mock_mode(self, mock_run_shell, mock_env, minimal_config, temp_output_dir):
    ...
    @patch('krkn_ai.chaos_engines.krkn_runner.run_shell')
    def test_run_handles_misconfiguration_failure(self, mock_run_shell, mock_env, minimal_config, temp_output_dir):
    ...
    def test_run_raises_for_unsupported_scenario_type(self, minimal_config, temp_output_dir):
